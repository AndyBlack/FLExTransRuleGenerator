namespace SIL.FLExTransRuleGenerator.Control
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.logoPictureBox.Size = new System.Drawing.Size(197, 197);
			...
			this.labelProductName.Text = "FLExTrans Rule Generator";
			...
			this.labelVersion.Text = "Version 0.1 Alpha";
			...
			this.textBoxDescription.Text = "This software is licensed under the LGPL, version 2.1 or later\\n(http://www.gnu.o" +
    "rg/licenses/lgpl-2.1.html)";
			// 
			// okButton
			// 
